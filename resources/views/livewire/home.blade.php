        ...
        <section class="w-full mx-auto max-w-[1500px] lg:mt-[-85px]">
            <div class="space-y-10">
                ...
                <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-7 px-10 sm:px-2">
                    <a href="http://3drgb.test/product-category/%D9%85%D8%AF%D9%84-%D8%B3%D9%87-%D8%A8%D8%B9%D8%AF%DB%8C/%D8%B3%D9%87-%D8%A8%D8%B9%D8%AF%DB%8C"
            ...
            <div class="mx-auto  w-full ">
                <div class="py-4">
                    <nav class="flex justify-center gap-2  lg:text-2xl font-bold py-5" aria-label="Tabs"
                        ...
                        <button type="button"
                            ...
                            onclick="topProductBtn()" aria-controls="tabs-with-underline-1" role="tab">
                            بالاترین امتیاز
                        </button>
                        <button type="button"
                            ...
                            onclick="newProductBtn()" aria-controls="tabs-with-underline-2" role="tab">
                            جدید ترین
                        </button>
                        <button type="button"
                            ...
                            onclick="successProductBtn()" aria-controls="tabs-with-underline-3" role="tab">
                            پرفروش ترین
                        </button>
                    </nav>
                </div>
                ...
                <div class="mt-3 flex flex-col items-center ">
                                    ...
                                    <div
                                        ...
                                        <div>
                                            <a href="#"
                                                ...
                                                <div class="p-3 w-[80%] ">
                                                    <img src="{{ asset('home-page/images/3D-rgb-10000.png') }}"
                                                        alt="">
                                                </div>
                                                <div class="w-full flex flex-col justify-center items-center gap-3">
                                                    <p
                                                        class="text-[#000BEE] dark:text-[#D1D1D1] text-xs lg:text-sm font-bold p-0 m-0">
                                                        سه بعدی/غذا
                                                    </p>
                                                    <p
                                                        class="font-bold text-sm lg:text-xl text-stone-800 dark:text-white ">
                                                        مدل سه بعدی غذا همبرگر</p>
                                                    <p
                                                        class="font-bold text-sm lg:text-xl text-stone-800 dark:text-white ">
                                                        9000 تومان</p>
                    ...
                    <div id="tabs-with-underline-2" class="hidden" role="tabpanel"
                        ...
                        <div id="tabs-with-underline-2-1" class=""
                            role="tabpanel"aria-labelledby="tabs-with-underline-item-2-1">
                            <div class="flex justify-between text-sm">
                                <div class="flex justify-between text-sm duration-500 transition-all w-full ">
                                    <div
                                        class="flex gap-4 xl:gap-5 overflow-x-scroll w-screen lg:w-[92vw]  px-3 xl:w-auto scrollbar  duration-500 transition-all">
                    ...
                    <div id="tabs-with-underline-3" class="hidden" role="tabpanel"
                        ...
                        <div id="tabs-with-underline-3-1" class=""
                            role="tabpanel"aria-labelledby="tabs-with-underline-item-3-1">
                            <div class="flex justify-between text-sm">
                                <div class="flex justify-between text-sm duration-500 transition-all w-full ">
                                    <div
                                        class="flex gap-4 xl:gap-5 overflow-x-scroll w-screen lg:w-[92vw]  px-3 xl:w-auto scrollbar  duration-500 transition-all">
                ...
                <!-- show more products -->
                <div id="top-product-btn" class="flex justify-center gap-3 lg:text-2xl font-bold mt-10"
                ...
                <div id="new-product-btn" class="justify-center gap-3 lg:text-2xl font-bold mt-10 hidden"
                    aria-label="Tabs" role="tablist">
                    <button type="button"
                        class="bg-[#CDD6FC] p-2 rounded-full duration-500 transition-all  hs-tab-active:w-10 hs-tab-active:bg-[#000BEE] dark:hs-tab-active:bg-[#C2008C] slyder-but active "
                ...
                <div id="success-product-btn" class="justify-center gap-3 lg:text-2xl font-bold mt-10 hidden"
                    aria-label="Tabs" role="tablist">
                    <button type="button"
                        class="bg-[#CDD6FC] p-2 rounded-full duration-500 transition-all  hs-tab-active:w-10 hs-tab-active:bg-[#000BEE] dark:hs-tab-active:bg-[#C2008C] slyder-but active "
