@section('title', 'سه بعدی متا - فروشگاه مدل های سه بعدی')
@section('description', 'مرکز عرضه جدیدترین مدل سه بعدی، آیکون، انیمیشن و فایل های طراحی با تعرفه ثابت')
@section('keywords', 'مدل سه بعدی, فروشگاه مدل سه بعدی, انیمیشن سه بعدی, آیکون, طراحی سه بعدی')
@section('og:title', 'سه بعدی متا')
@section('og:description', 'مرکز عرضه جدیدترین مدل سه بعدی، آیکون، انیمیشن و فایل های طراحی')
@section('og:image', asset('home-page/images/Asset2.png'))
<div>
    <main>
        <section>
        ...
        <section class="w-full mx-auto  max-w-[1500px]   lg:px-9 3xl:px-0 my-20 mb-[400px]">
            <div class="flex flex-col lg:flex-row gap-y-7 justify-between items-center ad-section">
                ...
                <div class="flex flex-col gap-10 justify-start items-center w-full lg:w-[60%]">
                    <p class="text-[26px] md:text-4xl  px-14 py-10 text-[#000BEE]  dark:text-dark-yellow"
                        style="font-family:rokh-ebold ;"> آواتار رویایی خود را رایگان بسازید! </p>
                    ...
                    <a href="{{ route('avatars') }}"
                        class="bg-primery-blue rounded-2xl px-10 py-3 text-white dark:text-black dark:bg-dark-yellow lg:text-xl">همین
                        حالا آواتار بسازید</a>
                </div>
                            ...
                            @forelse ($this->popularCategories as $category)
                                <div class="flex flex-shrink-0 relative  ">
                                    <a href="{{ route('categories.show', ['category_link' => $category->url]) }}"
                                        ...
                                        <div class="w-full ">
                                            <img src="{{ asset($category->image->url ?? 'home-page/images/default-product.jpg') }}"
                                                loading="lazy" alt="دسته {{ $category->name }}"
        ...
        <section class="w-full max-w-[1500px] mx-auto px-5 lg:px-9 3xl:px-0">
            ...
            <div class="mx-auto  w-full ">
                <div class="py-4">
                    <nav class="flex justify-center gap-2 lg:text-2xl font-bold py-5" role="tablist"
                        style="font-family:rokh;">
                        <button type="button"
                            ...
                            id="order-by-score" aria-label="Sort by highest score" role="tab"
                            aria-selected="true">
                            بالاترین امتیاز
                        </button>
                        <button type="button"
                        ...
                        <button type="button"
                            ...
                            id="order-by-sales" aria-label="Sort by best selling" role="tab"
                            aria-selected="false">
                            پرفروش ترین
                        </button>
                    </nav>
