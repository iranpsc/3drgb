            ...
            <section class="max-w-[1500px] mx-auto  lg:p-9 mt-24 lg:mt-14 flex flex-col lg:flex-row gap-5 ">
                        ...
                        <div class="flex flex-col gap-3">
                            <span class="multi-range">
                                <input type="range" min="0" max="10000000" value="0" step="1"
                                    name="minprice" id="minPrice" wire:model.live.debounce.500ms="price_filter.min">
                                <input type="range" min="0" max="9000000" value="479900" step="1"
                                    name="maxprice" id="maxPrice" wire:model.live.debounce.500ms="price_filter.max">
                            </span>
                        </div>
                ...
                <div class="w-full lg:w-3/4 space-y-5 p-5" id="products-list">
                    <div class="flex flex-col-reverse lg:flex-row gap-6">
                        <nav role="tablist"
                            class="flex items-center gap-6 w-[100%] lg:w-[70%] scrollbar overflow-y-hidden overflow-x-auto"
                            style="height: 55px;">
