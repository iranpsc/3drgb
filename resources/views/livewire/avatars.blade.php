        ...
        <div class="row justify-content-center">
            <div class="flex flex-col gap-5">
                <button type="button" id="openModalBtn"
                    class="px-11 py-3 bg-primery-blue dark:bg-dark-yellow rounded-[10px] dark:text-black text-white">
                    ایجاد آواتار
                </button>

                <x-modal2 title="ایجاد آواتار" id="myModal" class="w-full">
                    <div class="w-full flex flex-col items-center gap-5">
                        ...
                        <button id="saveAvatarBtn" wire:loading.attr="disabled" wire:click="save"
                            class="px-11 py-3 bg-primery-blue dark:bg-dark-yellow rounded-[10px] dark:text-black text-white hidden">
                            ذخیره آواتار
                        </button>
                    </div>
                </x-modal2>
                        ...
                        @foreach ($products as $product)
                            <tr>
                                ...
                                <td class="flex  justify-center items-center"><a href="{{ $product->latestImage->url }}"
                                        target="_blank"><img class="w-[120px] rounded-lg"
