                ...
                <div class="w-full flex flex-col justify-center items-center gap-3">
                  ...
                  <div class="w-full flex justify-between gap-2 ">
                    ...
                    @else
                        ...
                        <button type="button" wire:click="purchase({{ $product->id }})" class="rounded-lg w-[40%]  px-2 py-3 bg-[#D8E5FD] dark:bg-[#4A4E7C]  text-[#000BEE] dark:text-[#E8E9FF] m-0 text-xs lg:text-sm font-bold z-10 ">خرید</button>
                    @endif
                  </div>
                </div>
              </div>
