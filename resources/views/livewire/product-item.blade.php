    ...
    <div class=" product w-full">
        <div
            ...
            <a href="{{ $product->url }}" style="width: 90% ;margin-top: 16px" class="overflow-hidden rounded-lg">
                <img src="{{ $product->oldestImage->url ?? asset('home-page/images/default-product.jpg') }}" alt="{{ $product->category->name }}" loading="lazy" onerror="this.onerror=null; this.src='{{ asset('home-page/images/default-product.jpg') }}';">
            </a>
