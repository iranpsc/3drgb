           ...
           <div class="row">
                       ...
                       <div class="row">
                          <div class="col-xl-6">
                             <div class="card-body px-25">
                                <h1 class="banner-feature__heading color-white">به داشبورد نمایشی خوش آمدید</h1>
                                <p class="banner-feature__para color-white">انواع مختلفی از معابر از وجود دارد لورم ایپسوم در دسترس است، اما اکثریت آنها آسیب دیده اند تغییر به نوعی</p>
                                <div class="d-flex justify-content-sm-start justify-content-center">
                                   <button class="banner-feature__btn btn btn-primary color-white btn-md px-20 radius-xs fs-15" type="button">بیشتر بیاموزید</button>
                                </div>
                             </div>
                          </div>
                          <div class="col-xl-6">
              ...
              <div class="col-xxl-8 mb-25">
                 ...
                 <div class="card border-0 px-25 h-100">
                    <div class="card-header px-0 border-0">
                       <h6> نمای کلی کاربر</h6>
                       <div class="card-extra">
                          <ul class="card-tab-links nav-tabs nav" role="tablist">
                             <li>
                                <a href="#salesgrowth" data-bs-toggle="tab" id="salesgrowth-tab" role="tab" aria-selected="false">امروز</a>
                             </li>
                             <li>
                                <a href="#salesgrowth2" data-bs-toggle="tab" id="salesgrowth2-tab" role="tab" aria-selected="false">هفته</a>
                             </li>
                             <li>
                                <a class="active" href="#salesgrowth3" data-bs-toggle="tab" id="salesgrowth3-tab" role="tab" aria-selected="true">ماه</a>
                             </li>
                          </ul>
                       </div>
                    </div>
                          ...
                          <div class="tab-pane" id="salesgrowth" role="tabpanel" aria-labelledby="salesgrowth-tab">
                             <div class="label-detailed label-detailed--two">
                                <div class="label-detailed__single">
                                   <span class="label-detailed__type label-detailed__type--primary">هدف</span>
                                ...
                                <div class="label-detailed__single">
                                   <span class="label-detailed__type label-detailed__type--info">به دست آورد</span>
                 ...
                 <div class="card border-0 px-25 pb-15 h-100">
                    <div class="card-header px-0 border-0">
                       ...
                       <div class="card-extra">
                          <ul class="card-tab-links nav-tabs nav" role="tablist">
                             <li>
                                <a class="active" href="#t_selling-today22" data-bs-toggle="tab" id="t_selling-today22-tab" role="tab" aria-selected="true">امروز</a>
                             </li>
                             <li>
                                <a href="#t_selling-week22" data-bs-toggle="tab" id="t_selling-week22-tab" role="tab" aria-selected="true">هفته</a>
                             </li>
                             <li>
                                <a href="#t_selling-month33" data-bs-toggle="tab" id="t_selling-month33-tab" role="tab" aria-selected="true">ماه</a>
                             </li>
                          </ul>
                       </div>
                    </div>
                 ...
                 <div class="card border-0 px-25 pb-10 project-task-list--event">
                    <div class="card-header px-0 border-0">
                       ...
                       <div class="card-extra me-1">
                          <ul class="card-tab-links nav-tabs nav" role="tablist">
                             <li>
                                <a class="active" href="#t_selling-today2222" data-bs-toggle="tab" id="t_selling-today2222-tab" role="tab" aria-selected="true">امروز</a>
                             </li>
                             <li>
                                <a href="#t_selling-week2222" data-bs-toggle="tab" id="t_selling-week2222-tab" role="tab" aria-selected="true">هفته</a>
                             </li>
                             <li>
                                <a href="#t_selling-month3333" data-bs-toggle="tab" id="t_selling-month3333-tab" role="tab" aria-selected="true">ماه</a>
                             </li>
                          </ul>
                       </div>
                    </div>
                                         ...
                                         <td>
                                            <div class="event-Wrapper">
                                               ...
                                               <div class="event-Wrapper__right">
                                                  <h6>برنامه ریزی برای طراحی جدید داشبورد و طرح اولیه</h6>
                                                  <span>08:30 AM</span>
                                               </div>
                                            </div>
                                         </td>
                                      ...
                                      <tr class="project-task-list">
                                         <td>
                                            <div class="event-Wrapper">
                                               ...
                                               <div class="event-Wrapper__right">
                                                  <h6>کنفرانس بین المللی وب 2021</h6>
                                                  <span>08:30 AM</span>
                                               </div>
                                            </div>
                                         </td>
              ...
              <div class="col-xxl-4 mb-25">
                 <div class="card knowledge-base border-0 py-sm-30 px-sm-25">
                    ...
                    <h1>پایگاه دانش</h1>
                    <p>انواع مختلفی از معابر لورم ایپسوم موجود است اما اکثر آنها دچار تغییر شده اند</p>
                    <button type="button" class="btn btn-primary">مقاله را مرور کنید</button>
                 </div>
              </div>
                             ...
                             <li>
                                <div class="card-timeline-body__left">
                                   <div class="card-timeline-body__title">
                                      ...
                                      <p>یک سایت خدمات ایجاد کنید <span>2015-09-01</span></p>
                                   </div>
                                </div>
                             ...
                             <li>
                                <div class="card-timeline-body__left">
                                   <div class="card-timeline-body__title">
                                      ...
                                      <p>حل مشکلات اولیه شبکه <span>2015-09-01</span></p>
                                   </div>
                                </div>
                                <div class="card-timeline-body__right">
                                   <div class="card-timeline-body__time">
                             ...
                             <li>
                                <div class="card-timeline-body__left">
                                   <div class="card-timeline-body__title">
                                      ...
                                      <p>تست فنی <span>2015-09-01</span></p>
                                   </div>
                                </div>
                                <div class="card-timeline-body__right">
                                   <div class="card-timeline-body__time">
                             ...
                             <li>
                                <div class="card-timeline-body__left">
                                   <div class="card-timeline-body__title">
                                      ...
                                      <p>مشکلات شبکه در حال حل شدن است <span>2015-09-01</span></p>
                                   </div>
                                </div>
                                <div class="card-timeline-body__right">
                                   <div class="card-timeline-body__time">
                          ...
                          <ul>
                             <li>
                                <div class="card-inbox-members__left">
                                   ...
                                   <div class="card-inbox-members__title">
                                      <h6>شین واتسون</h6>
                                      <div class="card-inbox-members__title--online">ما به دنبال یک توسعه دهنده فول استک هستیم</div>
                                   </div>
                                </div>
                             ...
                             <li>
                                <div class="card-inbox-members__left">
                                   ...
                                   <div class="card-inbox-members__title">
                                      <h6>کریس دوهان</h6>
                                      <div class="card-inbox-members__title--online">آفرین، کار عالی</div>
                                   </div>
                                </div>
                                <div class="card-inbox-member__right">
                                   <div class="card-inbox-member__time">
                             ...
                             <li>
                                <div class="card-inbox-members__left">
                                   ...
                                   <div class="card-inbox-members__title">
                                      <h6>اشکان نوری</h6>
                                      <div class="card-inbox-members__title--online">امشب قراره جدید رو ارسال کنیم...</div>
                                   </div>
                                </div>
                                <div class="card-inbox-member__right">
                                   <div class="card-inbox-member__time">
                 ...
                 <div class="blog-card">
                    ...
                    <div class="blog-card__details">
                       <div class="blog-card__content">
                          <div class="blog-card__title--top">13 شهریور 1402</div>
                          <h4 class="blog-card__title">
                             <a href="#" class="entry-title" rel="bookmark"> واژه نامه نهایی اصطلاحات درباره</a>
                          </h4>
                          <p>تغییرات زیادی در قسمت های اکثریت وجود دارد که به نوعی دچار تغییر شده اند</p>
                       </div>
                 ...
                 <div class="blog-card">
                    ...
                    <div class="blog-card__details">
                       <div class="blog-card__content">
                          <div class="blog-card__title--top">13 شهریور 1402</div>
                          <h4 class="blog-card__title">
                             <a href="#" class="entry-title" rel="bookmark">ایده طراحی داشبورد چندگانه</a>
                          </h4>
                          <p>تغییرات زیادی در قسمت های اکثریت وجود دارد که به نوعی دچار تغییر شده اند</p>
                       </div>
                       <div class="blog-card__meta">
                 ...
                 <div class="blog-card">
                    ...
                    <div class="blog-card__details">
                       <div class="blog-card__content">
                          <div class="blog-card__title--top">13 شهریور 1402</div>
                          <h4 class="blog-card__title">
                             <a href="#" class="entry-title" rel="bookmark">چگونه یک داشبورد مبتنی بر طاقچه ایجاد کنیم</a>
                          </h4>
                          <p>تغییرات زیادی در قسمت های اکثریت وجود دارد که به نوعی دچار تغییر شده اند</p>
                       </div>
                       <div class="blog-card__meta">
