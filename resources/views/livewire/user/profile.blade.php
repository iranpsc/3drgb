                    ...
                    <div class="mt-5">
                        <div class="">
                            <form wire:submit="updateProfileInformation" class="grid lg:grid-cols-2 gap-7 ">
                                ...
                                <x-form.text wire:model="email" name="email" type="email" label="ایمیل"
                                    placeholder="ایمیل" />
                                <x-form.text wire:model="phone" name="phone" label="تلفن همراه"
                                    placeholder="تلفن همراه" />
                                <x-form.file wire:model="avatar" name="avatar" label="تصویر پروفایل"
